        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-[40px] mb-[60px]">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-[16px]">
              ...
              <li className="flex items-center gap-[12px] text-[#b0b0cc] text-[0.95rem]"><FiPhone className="text-[#6C63FF]" /> +880 1234-567890</li>
              <li className="flex items-center gap-[12px] text-[#b0b0cc] text-[0.95rem]"><FiMapPin className="text-[#6C63FF]" /> Dhaka, Bangladesh</li>
            </ul>
          </div>
        </div>
